  ...
  async function handleTrack(
    ...
    try {
      const response = await fetch(
        `/api/petitions/track/${trackCode.trim()}`
      );
      ...
      if (!response.ok) {
        setTrackError(
          data.error || "Başvuru bulunamadı."
        );
      } else {
        setTrackResult(data.petition);
      }
    } catch {
    ...
    <div className="page-wrapper">
      ...
      >
        <div className="page-hero-inner">
          ...
          <p>
            Mersin Üniversitesi&apos;ne dilek, öneri ve
        ...
        >
          <div className="card">
            ...
            >
              ...
              >
                Üniversitemize talep, şikayet, öneri veya
                teşekkürünüzü iletmek için başvuru
                oluşturun.
              </p>
